...
class DQRunner:
    ...
    def __init__(
        self,
        watermark_table_path: str = "/tmp/dq_watermarks",
        ...
        Args:
            watermark_table_path: Path to watermark table
            logger: Optional logger instance
        """
        self.logger = logger or self._setup_logger()
        self.watermark_manager = self._init_watermark_manager(watermark_table_path)
    ...
    def _init_watermark_manager(self, watermark_table_path: str) -> WatermarkManager:
